...
-------------------------------------------------- */
$('#quantity .product_quantity_up').click(function () {
	let quantity_control = $(this).closest('.quantity-control');
	let quantityInput = quantity_control.find('input[name="quantity"]');
...
$('#quantity .product_quantity_down').click(function () {
	let quantity_control = $(this).closest('.quantity-control');
	let quantityInput = quantity_control.find('input[name="quantity"]');
	let quantity = parseInt(quantityInput.val(), 10) || 0;
...
$(function () {
	...
	$('.defaultCountdown-30').countdown(endTime, function (event) {
